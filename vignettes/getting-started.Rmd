...
[`mark_text()`](../reference/mark_text.html) draws a label per point, and
...
[`facet()`](../reference/facet.html) splits a plot into small multiples by
...
[`marginals()`](../reference/marginals.html) adds histograms, density
...
[`inset()`](../reference/inset.html) places a second, smaller glyph_spec
